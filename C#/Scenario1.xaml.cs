...
namespace simpleInk
{
    ...
    public sealed partial class Scenario1 : SDKTemplate.Common.LayoutAwarePage
    {
        ...
        public void DispatcherTimerSetup()
        {
            ...
            //Timer.Text += "dispatcherTimer.IsEnabled = " + dispatcherTimer.IsEnabled + "\n";
            startTime = DateTimeOffset.Now;
            lastTime = startTime;
            //Timer.Text += "Calling dispatcherTimer.Start()\n";
        ...
        void dispatcherTimer_Tick(object sender, object e)
        {
            ...
            //Timer.Text += timesTicked + "\t time since last tick: " + span.ToString() + "\n";
            timesTicked++;
            if (timesTicked > timesToTick)
            {
                stopTime = time;
                //    Timer.Text += "Calling dispatcherTimer.Stop()\n";
        ...
        int score = 0;
        string[] dict = { "A", "B", "U","I", "D" };
        int dictptr = 2;
        async void OnRecognize()
        {
            if (inkManager.GetStrokes().Count > 0 || true)
            {
                ...
                try
                {
                    ...
                    dictptr = rnd.Next(0, dict.Length);
                    rootPage.NotifyUser(str + "\n" + "Score: " + score.ToString(), SDKTemplate.NotifyType.StatusMessage);
                    inkManager.DeleteAll();
                    renderer.Clear();
